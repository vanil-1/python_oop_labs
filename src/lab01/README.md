...
Далее представлена реализация класса, а также конструкт __init__, в котором при объявлении атрибутов проходит валидация значении.
...
1. Нормальное поведение программы, при корректном создании объекта, т.е. создание объекта, вывод информации о объекти в виде удобной таблицы, бизнес-метод - расёт стоимости аренды за минимальный срок аренды, который установлен арендодателем, бизнес-метод - заключить контракт об аренде, а также вывод свойста объекта - арендован/не арендован дом:

![sorry, something is wrong(...](/images/lab01/demo/scen1.png)
...
![sorry, something is wrong(...](/images/lab01/demo/scen2.png)

3. Сравнение домов:

![sorry, something is wrong(...](/images/lab01/demo/scen3.png)
